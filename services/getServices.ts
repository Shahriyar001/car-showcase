...
//   const res = await axios("https://car-showcase-three-henna.vercel.app/services/api/get-all");
//   return res.data;
// };

// export const getServicesDetails = async (id: any) => {
//   const res = await fetch(`https://car-showcase-three-henna.vercel.app/services/api/${id}`);
//   const service = res.json();
//   return service;
// };

// export const getCars = async () => {
//   const res = await axios("https://car-showcase-three-henna.vercel.app/api/cars/get-all");
//   console.log(res.data);
//   return res.data;
// };

// export const getCarsDetails = async (id: any) => {
//   const res = await fetch(`https://car-showcase-three-henna.vercel.app/api/cars/${id}`);
//   const car = res.json();
//   return car;
// };
